...
//八邻域rewrite
//记录左边界的数据
uint8_t border_location_left[400][2] = { 0 };  //记录边界位置
uint8_t border_count_left = 0;
int8_t growth_direction_left[400] = { -1 };  //记录生长方向
uint16_t growth_count_left = 0;
//记录右边界的数据
uint8_t border_location_right[400][2] = { 0 };  //记录边界位置
uint8_t border_count_right = 0;
int8_t growth_direction_right[400] = { -1 };  //记录生长方向
