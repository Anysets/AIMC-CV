...
y值最大*******************************************(94.60)
*/
#define ROAD  "/home/anysets/Documents/AIMC-CV/AIMC/frame_129.png"
...
void optimizeBorder()
{
    // 左边界的部分
    // 循环已经提取到的边界，去除不需要的点
    printf("Left border optimize start.\n");
    for (int i = 0; i < border_length; i++)
    {
        // printf("%d\n", i);
